...
TaskService.prototype.save = function (hash) {
    ...
    return _this.find(hash.id).then(function (task) {
        ...
        return _this._computeChildNumber();
    }).then(function () {
        _this._write();
    });
};
...
TaskService.prototype.create = function (hash) {
    ...
    return _this._computeChildNumber().then(function () {
...
TaskService.prototype._computeChildNumber = function () {
    var _this = this;
    return Promise.all(Object.keys(this._tasks).map(function (key) {
        var task = _this._tasks[key];
        return _this.findChildren(task.id).then(function (tasks) {
            task.undoneChildren = tasks.filter(function (task) {
